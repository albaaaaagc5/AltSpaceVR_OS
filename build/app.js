...
class AlarmTimer {
    constructor(context, params, baseUrl) {
        ...
        this.initialTimerCount = parseInt(parameter_set_util_1.getParameterLastValue(params, 'c', '300'));
        ...
        this.alarmSoundPath = parameter_set_util_1.getParameterLastValue(params, 'as', 'alarm.ogg');
